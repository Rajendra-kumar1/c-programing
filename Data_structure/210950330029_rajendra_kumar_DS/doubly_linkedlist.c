//write a Doubly linked list program with following operations
#include<stdio.h>
#include<stdlib.h>
...
struct node
{
 ...
 int main()
 {
  ...
  {                                               //decleration all oprations
    ...
    switch (i)                                      //switch statement using diffirent cases
    {
     case 1:
...
void insert_B(int ele)                //insert element biginning
{
 struct node *temp;
...
void insert_E(int ele)          // insert element end
{
 struct node *temp;
 temp =(struct node *)malloc(sizeof(struct node));
 temp->data = ele;
...
void insert_L(int loc, int ele)            //insert element specific location
{
...
void delete_B()                //delete element at biginning
{
 struct node *temp;
 temp = front;
 if (temp == NULL)
