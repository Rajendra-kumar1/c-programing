...
int  main()
{
    ...
    printf("3.Insert at perticular location \n");     //perticular node
    printf("4.Display\n");          //display
    ...
    if(scanf("%d",&i)<=0){
        ...
        switch(i)                //switch(i), diffirent case
        {
...
void insert(int num)    //insertion biginning
{
    struct node *temp;
    ...
    void insert_end(int num)         //insertion end
     {
...
void insert_loc(int num, int loc)     //insertion sepicific location
 {
    int i;
...
int delete(int num)                       //delete specific (data)
{
...
void  display(struct node *r)       //display list element
{
    r=head;
    if(r==NULL)
    {
...
int count()              //find the number in the linked list
{
    struct node *n;
    int c=0;
    n=head;
